      ...
      <!-- End na ng  Main Content -->

      <!-- This is the Footer -->
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
              <span>Invent Pro || Inventory Management System</span>
          </div>
        </div>
      </footer>
      <!-- End ng Footer -->
    ...
    <!-- End ng Content Wrapper -->

  </div>
  <!-- End ng Page Wrapper -->

  <!-- Use for scrolling to Top Button-->
  ...
  <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body"><?php echo  $_SESSION['FIRST_NAME']; ?> Are you sure that you want to logout?</div>
