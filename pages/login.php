...
<head>
  ...
  <title>Invent Pro</title>
  <link rel="icon" href="https://www.freeiconspng.com/uploads/sales-icon-7.png">

  <!-- Custom fonts for this template-->
  <link href="../vendor/fontawesome-free-5.15.3-web/css/all.min.css" rel="stylesheet" type="text/css">
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Welcome to Invent Pro!</h1>
                  </div>
                  <form class="user" role="form" action="processlogin.php" method="post">
                    ...
                    <hr>
                  <!-- <div class="text-center" (Better not to use Hahahha to much is pain)>
