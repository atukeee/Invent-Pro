    ...
    echo '</pre>';
                ...
                <div class="col-lg-12">
                  ...
                  <div class="card-header py-2">
                    <h4 class="m-1 text-lg text-primary">PRODUCT CATEGORIES</h4>
                  </div>
                        <!-- /.panel-heading -->
                        <div class="card-body">
                            <!-- Nav tabs -->
                            <!-- EXAMPLE MUNA YUNG PC COMPONENTS-->
...
<!-- TAB PANE AREA - THEN PUNTA KA SA TABS PARA SA TABPANE.PHP -->
<?php include 'postabpane.php'; ?>
<!-- END TAB PANE AREA - THEN PUNTA KA SA TABS PARA SA TABPANE.PHP -->
      ...
      <div class="card-body col-md-9">
        ...
        <!-- TRY MUNA HEHEHE(sana gumana Hahahhaa)   -->
